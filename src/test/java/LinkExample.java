...
public class LinkExample {
    ...
    public void openLinkTestPage(){
        ...
        driver.manage().window().maximize();//fit to screen size
    ...
    public void LinkTest(){
        ...
        int count = countFullPageLinks.size();
        System.out.println("Links in full page: "+ count);

        //06. Count Layout links
        WebElement layoutElement = driver.findElement(By.className("layout-main-content"));
        List<WebElement> countOfLayoutLink = layoutElement.findElements(By.tagName("a"));
        int layoutLinkCount = countOfLayoutLink.size();
